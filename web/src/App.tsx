...
<Dialog.Content className="fixed bg-[#2a2634] py-8 px-10 text-white top-20 left-1/2 -translate-x-1/2 -traslate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
  <Dialog.Title className="text-3xl  text-white font-black">Publique um anúncio</Dialog.Title>
  
    <form className="mt-8 flex flex-col gap-4">

      <div className="flex flex-col gap-2">
        <label htmlFor="game" className="font-semibolt">Qual o game?</label>
        <Input 
        id="game" 
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="yersPlaying">Joga a quantos anos?</label>
        <Input id="yersPlaying" placeholder="tudo bem ser 0"/>
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="mt-2 flex gap-2 text-sm">
        <input type="Checkbox" />Costumome conectar ao chat de voz
      </div>
